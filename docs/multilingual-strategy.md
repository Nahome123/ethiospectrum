...
The IEP and 504 accommodations guide follows the same source boundary. Its 187 supplied examples remain side-by-side English and Amharic in every application locale, while the resource card, navigation, progress labels, table labels, and educational notice have aligned English, Amharic, and Spanish keys. Amharic remains left-to-right. The supplied Amharic content and the new Amharic/Spanish interface copy require native review before release.
